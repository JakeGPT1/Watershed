    ...
    messages: [
      {
        ...
        content:
          ...
          'SENDER IS NOT ANONYMOUS: write in Jake\'s first-person voice, reference Watershed by name once in the body (e.g. "at Watershed I focus on placing GTM leaders at AI companies"), and sign off "Best,\\nJake\\nFounder, Watershed".\n\n' +
